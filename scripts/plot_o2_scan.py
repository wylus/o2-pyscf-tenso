...
INPUT_FILE = Path("data/o2_cas22_scan.csv")
PLOT_DIR = Path("plots")
...
def main():
    ...
    plt.title("O$_2$ CAS(2,2)/cc-pVDZ Potential-Energy Curves")
    plt.legend()
    plt.tight_layout()
    plt.savefig(PLOT_DIR / "o2_potential_curves.png", dpi=300)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(PLOT_DIR / "o2_triplet_quadratic_fit.png", dpi=300)
    plt.close()
    ...
    plt.figure(figsize=(7, 5))
    plt.plot(r, gap_ev, "o", label="Calculated CAS(2,2) gap")
    plt.plot(
        r_dense,
        gap_dense,
        "-",
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(PLOT_DIR / "o2_singlet_triplet_gap.png", dpi=300)
    plt.close()
    ...
    output_parameters.to_csv(
        "data/o2_extracted_parameters.csv",
        index=False,
    )
    ...
    print("\nSaved:")
    print("  plots/o2_potential_curves.png")
    print("  plots/o2_triplet_quadratic_fit.png")
    print("  plots/o2_singlet_triplet_gap.png")
    print("  data/o2_extracted_parameters.csv")
